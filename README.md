# Remember Git 
This repo has some useful information related with git  
The following information is taken from multiple sites on internet including   
* [coolestguidesontheplanet.com](https://coolestguidesontheplanet.com/install-update-latest-version-git-mac-osx-10-9-mavericks/)
```
